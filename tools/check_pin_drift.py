...
ROW_NAMES: dict[str, dict[str, str | None]] = {
    ...
    FIREBEETLE: {
        ...
        "Servo output GPIO 49 (left/top arm)": "PIN_ARM1_SERVO",
        "Servo output GPIO 50 (right/bottom arm)": "PIN_ARM2_SERVO",
        "Servo output GPIO 4 (can carry the LED strip)": "PIN_ARM3_SERVO",
        "Servo output GPIO 5 (can carry the LED strip)": "PIN_ARM4_SERVO",
        "Servo output GPIO 51 (can carry the LED strip)": "PIN_ARM5_SERVO",
