...
// sound.action.play-track/set-volume executors) include, rather than each
// consumer re-declaring its own `extern` - matches the precedent
// include/commanded_modes_test_hooks.h and include/rc_input_test_hooks.h
// already set for exactly this shape of native stub observation hook. Only
// the fields both callers need are declared here; test_api_audio_routes.cpp
// keeps its own extra externs for the fields only it observes (catalog
// contents, dollar/query/refresh/play-banked counters).
// =============================================================================
#pragma once
