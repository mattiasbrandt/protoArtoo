...
void test_static_tcp_episode_is_visible_in_snapshot() {
    ...
    webResponseTcpRecordAsyncClientAddFailure(-1, true, 7U, 16U, 2872U);
    ...
    TEST_ASSERT_EQUAL_UINT32(before.writeErrMem + 1U, after.writeErrMem);
    TEST_ASSERT_EQUAL_INT32(-1, after.lastWriteErr);
    TEST_ASSERT_EQUAL_UINT32(7U, after.lastWriteQueue);
    TEST_ASSERT_GREATER_OR_EQUAL_UINT32(7U, after.maxWriteQueue);
    TEST_ASSERT_EQUAL_UINT32(16U, after.writeQueueLimit);
    TEST_ASSERT_EQUAL_UINT32(2872U, after.lastWriteSize);
}
