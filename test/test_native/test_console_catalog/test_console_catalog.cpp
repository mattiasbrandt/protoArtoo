...
void test_catalog_count_and_iteration() {
    ...
    TEST_ASSERT_EQUAL_INT(199, count);  // Registry has 199 entries (#347 added servo.api.get-outputs, #363 servo.action.nudge, #364 servo.action.hold and servo.action.release)
