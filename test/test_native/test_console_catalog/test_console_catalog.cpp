...
void test_catalog_count_and_iteration() {
    ...
    TEST_ASSERT_EQUAL_INT(200, count);  // Registry has 200 entries (#347 added servo.api.get-outputs, #363 servo.action.nudge, #364 servo.action.hold and servo.action.release, #365 servo.action.centre-all, #352 servo.action.travel; #413 retired aux.config.led-pin)
