...
|---|---|---|---|---|---|---|---|---|---|---|---|
| **ROCKMARCH** | `@0T11` `@0P11` `@HPA0021\|47` | red MARCH logics + MARCH PSI + red holo flashes ~47 s | MARCH | red (`kRed`) | MARCH front+rear, 47 s | `HPA0021` red flashes, 47 s | ~47 s | body `@0T1`/`@0P1`/`*ST00` | **dome-source-confirmed + operator-confirmed** | native identity confirmed in `DomeSequences.h`; raw `@0T11` path renders **default blue** on hw; **not yet verified via `DV:`** | **first acceptance case** |
| **VADER** | `@0T11` `@0P11` `@HPA0021\|47` | red MARCH logics + MARCH PSI + red holo ~47 s (shares ROCKMARCH preset shape) | MARCH | red (`kRed`) | MARCH, 47 s | `HPA0021` red, 47 s | ~47 s | body `@0T1`/`@0P1`/`*ST00` | **dome-source-confirmed** | not visually verified | codex to confirm whether VADER preset is identical to ROCKMARCH or distinct |
| **CANTINA** | `@0T2` `@0P2` `@HPA0029\|15` | logic/PSI mode 2 + `HPA0029` white flashes ~15 s | TBD | TBD | TBD | TBD | ~15 s | body raw | body-inferred, needs dome confirmation | not visually verified | confirm against `DomeSequences.h` |
| **LEIA** | `@0T6` `@0P6` `@HPS101/HPR02/HPT02\|36` | logic/PSI mode 6 + Leia-message holo ~36 s | TBD | TBD | TBD | TBD | ~36 s | body raw | body-inferred, needs dome confirmation | not visually verified | confirm against `DomeSequences.h` |
| **ALARM** | `@0T3` `@0P3` `@HPA0021\|10` | logic/PSI mode 3 + `HPA0021` ~10 s | TBD | TBD | TBD | TBD | ~10 s | body raw | body-inferred, needs dome confirmation | not visually verified | confirm against `DomeSequences.h` |
| **HEART** | `@1MYou're Wonderful` `@1P2` `@HPF/HPR/HPT006\|10` | front text + PSI mode 2 + rainbow holos ~10 s | TBD | TBD | TBD | TBD | ~10 s | body raw | body-inferred, needs dome confirmation | not visually verified | text stays body-owned raw; `DV:HEART` covers PSI/holo only |
| **SCREAM** | `@0T5` `@0P5` `@HPA0070` `@HPA105\|5` | logic/PSI mode 5 + alarm/holo, random | TBD | TBD | TBD | TBD | random | body raw | body-inferred, needs dome confirmation | not visually verified | later `DV:SCREAM`; gated by pie-movement do-not-test (upper pie panels have known mechanical linkage issues, need repair) |
| **OVERLOAD** | `@1T4` `@2T4` `@0P4` `@HPA0070` | logic mode 4 (front/rear) + PSI mode 4 + `HPA0070`, random | TBD | TBD | TBD | TBD | random | body raw | body-inferred, needs dome confirmation | not visually verified | later `DV:OVERLOAD` |
