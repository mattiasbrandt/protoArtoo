...
| **Phase 4 — Audio + full dome link** | **In progress** — branch `phase/v0.4.0` active; software tasks T01–T09, T13–T21, T23, and T24 complete; T10 audio hardware partially validated (deterministic playback, named sounds, mood intervals confirmed on DY-SV5W); T11–T12 hardware-blocked; T22 deferred to Phase 5; see Phase 4 section below |
