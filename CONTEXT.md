...
- "feature flag" was used loosely for all three tiers; resolved by naming them **Board Capability Gate**, **Build Feature Flag**, and **Component Toggle**, and never using "feature flag" unqualified. A fourth tier joined them (#302, 2026-09-07): a **Component Member** names which member of a **Component Family** is fitted, wherever the image offers more than one to choose between (#302 again, 2026-09-09 — the condition was first written against the board's gate, and the gate answers a different question). The four answer four different questions — can this board be wired for it, is it in this image, is it fitted, and which one is it — and none of them is a "feature flag".
