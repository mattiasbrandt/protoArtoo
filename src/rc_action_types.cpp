// =============================================================================
// src/rc_action_types.cpp
//
// Implementation of RC action type parsing, string conversion, and validation.
...
// Human-readable string representation of a RobotActionId.
...
// Parse a string token to RobotActionId.
// Supports all action tokens defined in the enum.
...
// Map droid sequence action IDs to their sequence numbers.
...
// Format an RcTriggerBinding into a colon-delimited string.
...
// Parse a colon-delimited string back into an RcTriggerBinding.
// Format: source:channel:target:payload:min:center:max:deadband:reverse
