...
(() => {
  ...
  const ICONS = {
    ...
    // Wiring's, and the first path a slice has copied in from the twenty-two the
    // #398 prototype committed rather than fetching the package again
    // (docs/icon-set-provenance.md, prototypes/395-surface-anatomy/chrome.js:38).
